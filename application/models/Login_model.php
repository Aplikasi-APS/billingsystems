...
class Login_model extends CI_Model {
	  ...
	  //       }
		...
		// }
		// $this->db->select($data);
		$this->db->select('sessionlog.rowid as rowid, sessionlog.loginstamp as loginstamp, sessionlog.logoutstamp as logoutstamp, sessionlog.userrowid as userrowid, users.uid as uid');
		$this->db->from('sessionlog');
		$this->db->join('users','users.rowid = sessionlog.userrowid');
		$this->db->order_by('sessionlog.rowid');
		$query = $this->db->get();
		//$query = $this->db->get('sessionlog');
		return($query->result_array());
	}
