          ...
          <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a tabindex="0" class="menu1" style="display:none;" href="<?php  echo base_url();  ?>index.php/Quotation_Controller">PO</a></li> <!--Quotation-->
                  ...
                  <li><a tabindex="0" class="menu1" style="display:none;" href="<?php  echo base_url();  ?>index.php/Purchase_Controller">Billing</a></li> <!--Purchase-->
                  <li><a tabindex="0" class="menu1" style="display:none;" href="<?php  echo base_url();  ?>index.php/Sale_Controller">Invoice</a></li> <!--Sale-->
              ...
              <li class="dropdown">
                ...
                <!-- role="menu": fix moved by arrows (Bootstrap dropdown) -->
                    <ul class="dropdown-menu" role="menu">
                      <li><a tabindex="0" class="menu1" style="display:none;" href="<?php  echo base_url();  ?>index.php/History_Controller">History Login</a></li>
