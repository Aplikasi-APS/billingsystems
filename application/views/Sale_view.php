		...
		<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12" style='margin-top: 5px;'>
      	...
      	<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12" style='margin-top: 5px;'>
			<?php
				...
				echo "<input type='button' onclick='loadFromQuotation();' value='Items From PO' id='btnLoadFromQuotation' class='btn btn-primary btn-block' data-toggle='modal' data-target='#myModalQuotation'>";
          	?>
      	</div>
	</div>
	...
	<div class="row" style="margin-top: 20px;"> -->
		...
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
			<?php
				echo "<label style='color: black; font-weight: normal;'>&nbsp;</label>";
          	?>
          	<button id="btnSave" class="btn btn-success btn-block" onclick="saveData();">Save Invoice</button>
      	</div>
	</div>
