...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
			<h3 class="text-center" style='margin-top:-7px;'>PO</h3>
		</div>
    ...
    <div class="row" style="margin-top: 10px;">
		<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 sticky-table sticky-headers sticky-ltr-cells" id="divTable" style="overflow:auto; height:220px;">
			<table style="table-layout: fixed; border: 1px solid lightgrey;" id='tbl1' class="table table-bordered table-striped table-hover">
	           <thead>
	...
	<div class="row" style="margin-top: 10px;background-color: #F0F0F0; padding-top:10px;padding-bottom:10px;">
		...
		<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
			<?php
          	...
          	?>
          	<button id="btnSave" class="btn btn-success btn-block" onclick="saveData();">Save PO</button>
      	</div>
	</div>
